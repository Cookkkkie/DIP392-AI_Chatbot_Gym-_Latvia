...
public class ChatbotService {
    ...
    public String handleMessageRequest(String userId, String message) {
        ...
        log.debug("Updated conversationHistory for userId={}, newLength={} chars", userId,
                redisService.getHistory(userId).length());
    ...
    public void refreshSiteContent() {
        ...
        try {
            ...
            throw new RuntimeException(AppConstants.NO_FAQ_ERROR_MESSAGE, e);
        }
    }
...
// UserMessage(conversationHistory.toString()));
